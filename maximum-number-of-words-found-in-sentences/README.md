<h2>2114. Maximum Number of Words Found in Sentences</h2><h3>Easy</h3><hr><div bis_skin_checked="1"><p>A <strong>sentence</strong> is a list of <strong>words</strong> that are separated by a single space&nbsp;with no leading or trailing spaces.</p>
