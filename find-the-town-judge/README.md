<h2>997. Find the Town Judge</h2><h3>Easy</h3><hr><div bis_skin_checked="1"><p>In a town, there are <code>n</code> people labeled from <code>1</code> to <code>n</code>. There is a rumor that one of these people is secretly the town judge.</p>
